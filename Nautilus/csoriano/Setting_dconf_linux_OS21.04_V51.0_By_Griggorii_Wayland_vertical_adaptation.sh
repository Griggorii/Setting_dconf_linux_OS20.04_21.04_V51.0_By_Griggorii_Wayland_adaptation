...
draw-background=true
picture-filename='${prefix}/share/backgrounds/mate/desktop/Stripes.png'
picture-opacity=100
picture-options='zoom'
...
clear
EOF
(sh -c "/usr/bin/x-www-browser www.github.com/Griggorii/Setting_dconf_linux_OS20.04_21.04_V51.0_By_Griggorii_Wayland_adaptation") | (sleep 1; killall sh)
EOF
(sh -c budgie-panel) 
EOF
